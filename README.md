...
iCloud Drive desktop app for Windows. Loads [icloud.com/iclouddrive](https://www.icloud.com/iclouddrive) in a native **Tauri / WebView2** shell.
...
- **Deep link** — `icloud-drive://` protocol handler
